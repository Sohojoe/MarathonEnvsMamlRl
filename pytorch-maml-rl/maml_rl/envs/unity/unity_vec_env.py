...
class UnityVecEnv(VecEnv):
    """
    Creates a vectorized wrapper for multiple agent Unity ml-agents enviroment

    :param env_fns: (env_id) the Unity ml-agents  environment
    """
    ...
    def action_space(self, new_action_space):
        self.env._action_space = new_action_space

    @property
    def observation_space(self):
        return self.env.observation_space
    @observation_space.setter
    def observation_space(self, new_observation_space):
        self.env._observation_space = new_observation_space
