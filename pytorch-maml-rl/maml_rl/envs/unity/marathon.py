import numpy as np
from .unity_vec_env import UnityVecEnv
from gym.utils import seeding
 

class AntEnv(UnityVecEnv):
    def __init__(self, env_id):
        self.viewer = None
        self.seed()
        self._action_scaling = None
        super(AntEnv, self).__init__(env_id)
        # UnityVecEnv.__init__(self, env_id)
...
class AntVelEnv(AntEnv):
    ...
    def __init__(self, tasks=[{}]):
        self._tasks = tasks
        self._goal_vels = [task.get('velocity', 0.0) for task in tasks]
        self._action_scaling = None
        super(AntVelEnv, self).__init__('MarathonAntVel-v0')
    ...
    def reset_tasks(self, tasks):
        self._tasks = tasks
        self._goal_vels = [task['velocity'] for task in tasks]
